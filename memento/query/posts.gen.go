...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.IsPrivate = field.NewBool(tableName, "is_private")
	_post.Username = field.NewString(tableName, "username")
	_post.TotalLiked = field.NewInt64(tableName, "total_liked")
	_post.EditedAt = field.NewTime(tableName, "edited_at")
	_post.TotalComment = field.NewInt64(tableName, "total_comment")
	_post.ContentUrl = field.NewString(tableName, "content_url")
	...
	_post.Tags = postManyToManyTags{
		...
		Posts: struct {
			...
			Comments: struct {
				...
				RelationField: field.NewRelation("Tags.Posts.Comments", "model.Comment"),
			},
			Tags: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Tags.Posts.Tags", "model.Tag"),
			},
		},
	}
...
func (p *post) updateTableName(table string) *post {
	...
	p.IsPrivate = field.NewBool(table, "is_private")
	p.Username = field.NewString(table, "username")
	p.TotalLiked = field.NewInt64(table, "total_liked")
	p.EditedAt = field.NewTime(table, "edited_at")
	p.TotalComment = field.NewInt64(table, "total_comment")
	p.ContentUrl = field.NewString(table, "content_url")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["is_private"] = p.IsPrivate
	p.fieldMap["username"] = p.Username
	p.fieldMap["total_liked"] = p.TotalLiked
	p.fieldMap["edited_at"] = p.EditedAt
	p.fieldMap["total_comment"] = p.TotalComment
	p.fieldMap["content_url"] = p.ContentUrl
